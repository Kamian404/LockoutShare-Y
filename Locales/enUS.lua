...
L["ENTER_QUEUE"] = "Message When Entering Queue"
...
L["SETTING_MESSAGE"] = "Messages"
L["SETTING_COMMANDS"] = "Commands"
...
L["FAIL_FETCH"] = "Message when failing to fetch"
...
L["QUEUED"] = "You're queued. Position in queue: QCURR, estimated max. wait time: QWAIT"
L["QUEUED_SPAM_HEADER"] = "Message for repeat spam"
...
L["HEADER_LEAD_BEFORE"] = "Message for lead before entering"
L["COMMAND_LEAD"] = "You'll get the lead after you've entered the instance."
L["HEADER_LEAD_AFTER"] = "Message for lead after entering"
...
L["ADDON_INFO"] = "This is an Addon, created by Kamian (Yrni-Antonidas). Version: "
L["COMMAND_INFO"] = "I'm sharing raids & dungeons lockouts for free!"
...
L["VIP_MESSAGE"] = "Hi my VIP; You're the next one I'm inviting!"
L["BLACKLIST_COMMAND"] = "You must solve a CAPTCHA to prove you are not a robot. Please type the following: "
L["IN_QUEUE_MESSAGE"] = "Your current position is QCURR."
L["NOT_IN_QUEUE_MESSAGE"] = "You are not in the queue."
